//! Mnemonic
//! 
//! Copiend an lightly modified from:
//! https://github.com/diem/diem/blob/main/crates/diem-wallet/src/mnemonic.rs
//! 
...
impl Mnemonic {
    ...
    pub fn mnemonic(entropy: &[u8]) -> Result<Mnemonic> {
        ...
        if !(16..=32).contains(&len) || len % 4 != 0 {
          bail!("Entropy data for mnemonic must have one of the following byte lengths: \
                 32, 28, 24, 20, 16");
        }
